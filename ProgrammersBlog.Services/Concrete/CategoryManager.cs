...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        {
            var result = await _unitOfWork.Categories.AnyAsync(c=>c.Id==categoryId);  //böyle bir veri var mı?--> anyasync()
            if (result)
            {
        ...
        public async Task<IDataResult<CategoryDto>> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            var category = _mapper.Map<CategoryUpdateDto, Category>(categoryUpdateDto, oldCategory); //mapper kategorinin eski halini ve yeni halini map edecek ve createdbyname ve createddate alanları her update işleminden sonra yeniden yazılmamış olacak
            category.ModifiedByName = modifiedByName;
